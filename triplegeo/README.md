...
Build image for Triplegeo:
    ...
    docker build -f triplegeo.dockerfile -t local/triplegeo:1.8 .

Build image for reverse Triplegeo:

    docker build -f reverse-triplegeo.dockerfile -t local/reverse-triplegeo:1.8 .
